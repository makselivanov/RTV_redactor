...
class Menu(BoxLayout):
    ...
    def __init__(self, canvas_, **kwargs):
        ...
        self._dropdown_color.add_widget(Button(text='%s' % _colors[0], color=(1, 1, 1, 1), size_hint_y=None, height=44,
        ...
        self._btn_edit = Button(text='Eraser', font_size=24, on_release=self.choose_eraser)
    ...
    def bindings(self, save=None, clear=None):
    ...
    def choose_eraser(self, instance):
        ...
        self.canvas_.pen_color = (0, 0, 0, 1)
